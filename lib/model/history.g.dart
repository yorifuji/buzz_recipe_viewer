...
const HistorySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'searchHitHistory': PropertySchema(
      id: 1,
      name: r'searchHitHistory',
      type: IsarType.object,
      target: r'SearchHitHistory',
    ),
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'SearchHitHistory': SearchHitHistorySchema},
  getId: _historyGetId,
...
int _historyEstimateSize(
  ...
  bytesCount += 3 +
      SearchHitHistorySchema.estimateSize(
          object.searchHitHistory, allOffsets[SearchHitHistory]!, allOffsets);
  return bytesCount;
}
...
void _historySerialize(
  ...
  writer.writeObject<SearchHitHistory>(
    offsets[1],
    allOffsets,
    SearchHitHistorySchema.serialize,
    object.searchHitHistory,
  );
...
History _historyDeserialize(
  ...
  final object = History(
    reader.readObjectOrNull<SearchHitHistory>(
          offsets[1],
          SearchHitHistorySchema.deserialize,
          allOffsets,
        ) ??
        SearchHitHistory(),
  );
...
P _historyDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readObjectOrNull<SearchHitHistory>(
            offset,
            SearchHitHistorySchema.deserialize,
            allOffsets,
          ) ??
          SearchHitHistory()) as P;
    case 2:
      return (reader.readDateTime(offset)) as P;
    default:
...
extension HistoryQueryObject
    on QueryBuilder<History, History, QFilterCondition> {
  QueryBuilder<History, History, QAfterFilterCondition> searchHitHistory(
      FilterQuery<SearchHitHistory> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'searchHitHistory');
    });
  }
}
...
extension HistoryQueryProperty
  ...
  QueryBuilder<History, SearchHitHistory, QQueryOperations>
      searchHitHistoryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'searchHitHistory');
    });
  }
...
const SearchHitHistorySchema = Schema(
  name: r'SearchHitHistory',
  id: -3641652473284958080,
  properties: {
  ...
  estimateSize: _searchHitHistoryEstimateSize,
  serialize: _searchHitHistorySerialize,
  deserialize: _searchHitHistoryDeserialize,
  deserializeProp: _searchHitHistoryDeserializeProp,
);

int _searchHitHistoryEstimateSize(
  SearchHitHistory object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _searchHitHistorySerialize(
  SearchHitHistory object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
SearchHitHistory _searchHitHistoryDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = SearchHitHistory();
...
P _searchHitHistoryDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension SearchHitHistoryQueryFilter
    on QueryBuilder<SearchHitHistory, SearchHitHistory, QFilterCondition> {
  QueryBuilder<SearchHitHistory, SearchHitHistory, QAfterFilterCondition>
      descriptionIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension SearchHitHistoryQueryObject
    on QueryBuilder<SearchHitHistory, SearchHitHistory, QFilterCondition> {}
