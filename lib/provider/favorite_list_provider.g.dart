...
String _$favoriteListHash() => r'63b1c37fdd983156025cb35fc280acb5ec63b96f';

/// See also [FavoriteList].
@ProviderFor(FavoriteList)
final favoriteListProvider =
    AutoDisposeAsyncNotifierProvider<FavoriteList, List<Favorite>>.internal(
  FavoriteList.new,
...
typedef _$FavoriteList = AutoDisposeAsyncNotifier<List<Favorite>>;
